...
# ============================================
# Build QP safety filter pipeline
# ============================================
...
parts = cbfjax.from_config({
    'dynamics': dynamics,
    'barriers': {
        'map':  {'type': 'map', **map_config, 'cfg': cfg_qp},
        'state': {'type': 'soft_composition', 'barriers': ['map'], 'cfg': cfg_qp},
    },
    'filter': {
...
barrier_qp = parts.barriers['state']
...
# Thread safety filter state (which includes iLQR warm-start) through trajectory
...
# u_desired from QPInfo gives the warm-started iLQR desired control
