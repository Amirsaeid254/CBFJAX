"""
Parametric Flow Barrier II Simulation for JAX - Unicycle Example

Demonstrates:
- FlowBarrier2 with a backup-policy blended plan
...
# Control bounds
control_low = (-2.0, -0.5)   # (min linear velocity, min angular velocity)
control_high = (2.0, 0.5)    # (max linear velocity, max angular velocity)
...
def backup_policy(x):
    """Braking policy: saturated deceleration toward v = 0, no turning."""
...
plt.tight_layout()
plt.savefig(os.path.join(script_dir, f'figs/FlowBarrier2_Trajectory_{current_time}.png'), dpi=600)
plt.savefig(os.path.join(script_dir, f'figs/FlowBarrier2_Trajectory_{current_time}.svg'))
plt.savefig(os.path.join(script_dir, f'figs/FlowBarrier2_Trajectory_{current_time}.pdf'))
plt.show()
...
plt.tight_layout()
plt.savefig(os.path.join(script_dir, f'figs/FlowBarrier2_Combined_{current_time}.png'), dpi=600)
plt.savefig(os.path.join(script_dir, f'figs/FlowBarrier2_Combined_{current_time}.svg'))
plt.savefig(os.path.join(script_dir, f'figs/FlowBarrier2_Combined_{current_time}.pdf'))
plt.show()
...
plt.savefig(os.path.join(script_dir, f'figs/FlowBarrier2_Parameters_{current_time}.png'), dpi=600)
plt.savefig(os.path.join(script_dir, f'figs/FlowBarrier2_Parameters_{current_time}.svg'))
plt.savefig(os.path.join(script_dir, f'figs/FlowBarrier2_Parameters_{current_time}.pdf'))
plt.show()
...
plt.tight_layout()
plt.savefig(os.path.join(script_dir, f'figs/FlowBarrier2_BackupAnalysis_{current_time}.png'), dpi=600)
plt.savefig(os.path.join(script_dir, f'figs/FlowBarrier2_BackupAnalysis_{current_time}.svg'))
plt.savefig(os.path.join(script_dir, f'figs/FlowBarrier2_BackupAnalysis_{current_time}.pdf'))
plt.show()
...
def create_animation():
    ...
    animation_file = os.path.join(script_dir, f'figs/FlowBarrier2_Animation_{current_time}.mp4')
